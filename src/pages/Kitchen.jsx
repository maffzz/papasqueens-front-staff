        ...
        <>
          ...
          <div className="grid" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))' }}>
            {visibleQueue.map((order, index) => {
              ...
              return (
                <div className="card" key={orderId} style={{ 
                  position: 'relative',
                  borderLeft: '4px solid',
                  borderLeftColor: order.priority === 'high' ? '#dc2626' : order.priority === 'medium' ? '#eab308' : '#03592E'
                }}>
                  {order.priority === 'high' && (
                    <div style={{ 
                      position: 'absolute', 
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                      ...
                      >
                        {actionLoading[acceptKey] ? (
                          <><div className="loading" style={{ width: '14px', height: '14px' }}></div> Aceptando...</>
                        ) : (
                          <>✅ Aceptar</>
                        )}
                      </button>
                      ...
                      >
                        {actionLoading[packKey] ? (
                          <><div className="loading" style={{ width: '14px', height: '14px' }}></div> Empacando...</>
                        ) : (
                          <>📦 Empacar</>
                        )}
                      </button>
